...
def setup_argparse():
    ...
    parser.add_argument("--run", type=bool, nargs="?", default=False, help="Whether to run (default: False)")
...
def main():
    ...
    try:
        ...
        tasks = [
            "scripts/fa/plot_fa.py",
            "scripts/sas/plot_sas.py",
            "scripts/vs/plot_vs.py",
        ]
