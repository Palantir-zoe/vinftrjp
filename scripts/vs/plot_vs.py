...
def main():
    ...
    try:
        ...
        tasks = [
            "scripts/vs/plot_bbe_violin_some.py",
            "scripts/vs/plot_bbe_violin_all.py",
            "scripts/vs/plot_bbe_violin_all_vinf_ablation.py",
            "scripts/vs/plot_bbe_violin_all_vicnf_ablation.py",
        ]
