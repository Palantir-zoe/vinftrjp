...
def main():
    ...
    try:
        ...
        tasks = [
            "scripts/fa/run_fa_generate_posterior.py",
            "scripts/fa/run_fa_rjmcmc.py",
            "scripts/fa/run_fa_rjbridge.py",
            "scripts/fa/run_fa_rjmcmc_ablation.py",
            "scripts/fa/run_fa_rjbridge_ablation.py",
            "scripts/fa/plot_fa_proposal.py",
        ]
